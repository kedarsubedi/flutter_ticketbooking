    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    CircleAvatar(
                      child: Icon(
                        FluentSystemIcons.ic_fluent_lightbulb_filament_filled, color: Styles.primaryColor, size: 27,
                      ),
                      maxRadius: 25,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Styles.headLineStyle2.copyWith(
                            fontWeight: FontWeight.bold, color: Colors.white.withOpacity(0.7),
                            fontSize: 16
                          ),
                        )
                      ],
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("08 July 2023", style: Styles.headLineStyle4.copyWith(fontSize: 16),),
                ...
                const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    AppColumnLayout(firstText: "52 343",
                      secondText: "Miles",
                      alignment: CrossAxisAlignment.start,
                      isColor: false,
                    ),
                    AppColumnLayout(firstText: "Villiers",
                      secondText: "Received from",
                      alignment: CrossAxisAlignment.end,
                      isColor: false,
                    ),
          ...
          Gap(AppLayout.getHeight(25)),
          InkWell(
            onTap: () => print("You tapped for miles"),
            child: Center(
              child: Text(
