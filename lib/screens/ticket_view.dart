                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(child: Stack( //for widgets overlapping
                        children: [
                          SizedBox(
                          ...
                          Center(child: Transform.rotate(angle: 1.5, child: Icon(Icons.local_airport_rounded, color: Colors.white,),)),//same as spacer
                        ],
                      )),
                      const ThickContainer(),
                      const Spacer(),
